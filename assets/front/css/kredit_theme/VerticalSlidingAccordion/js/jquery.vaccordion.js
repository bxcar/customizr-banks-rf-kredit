				...
				return $.Deferred(
					function( dfd ) {
						...
						if( expanded ) {
							...
							itemHeight	= 60;//cache.sliceH;
							othersHeight= 60;//cache.sliceH;
						...
						// if it's closed..
							...
							settings.expandedHeight = settings.expandedHeight1;
							else
								if (cache.idx_expanded==1)
							settings.expandedHeight = settings.expandedHeight2;
							else
								if (cache.idx_expanded==2)
							settings.expandedHeight = settings.expandedHeight3;
							...
							//12.02 changeMD
							//othersHeight= 60;//Math.ceil( ( settings.accordionH - settings.expandedHeight ) / ( settings.visibleSlices - 1 ) );
						...
						$el.stop()
						   ...
						   .stop()
						   .animate({
							//	lineHeight	: '50px'//cache.sliceH + 'px'
			...
			init 		: function( options ) {
				...
				if( this.length ) {
					...
					return this.each(function() {
						...
						$el.css({
							width	: '100%',//settings.accordionW + 'px',
						...
						$slices.each(function(i){
							var $slice	= $(this);
							$slice.css({
								top		: i * 60 /*cache.sliceH*/ + 'px',
								height	: '60px'//cache.sliceH + 'px'
							}).data( 'position', (i + 1) );
						})
						.children('.va-title')
